...
/*
    ...
    public void testAddNewTask() {
        ...
        Task task = new Task("Opisanie", TaskState.CREATED, TaskPriority.HIGH, author, executor, new Date(), new Date(), 3, 0);
        taskService.addNew("Opisanie", TaskState.CREATED, TaskPriority.HIGH, author, executor, new Date(), new Date(), 3, 0);
